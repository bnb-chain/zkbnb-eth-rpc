...
//
// Solidity: function mint(uint256 _tokenId) returns()
func (_ERC721 *ERC721Transactor) Mint(opts *bind.TransactOpts, _tokenId *big.Int) (*types.Transaction, error) {
	return _ERC721.contract.Transact(opts, "mint", _tokenId)
}

// Mint is a paid mutator transaction binding the contract method 0xa0712d68.
//
// Solidity: function mint(uint256 _tokenId) returns()
func (_ERC721 *ERC721Session) Mint(_tokenId *big.Int) (*types.Transaction, error) {
	return _ERC721.Contract.Mint(&_ERC721.TransactOpts, _tokenId)
}

// Mint is a paid mutator transaction binding the contract method 0xa0712d68.
//
// Solidity: function mint(uint256 _tokenId) returns()
func (_ERC721 *ERC721TransactorSession) Mint(_tokenId *big.Int) (*types.Transaction, error) {
	return _ERC721.Contract.Mint(&_ERC721.TransactOpts, _tokenId)
}
...
//
// Solidity: function setTokenURI(uint256 _tokenId, string _tokenURI) returns()
func (_ERC721 *ERC721Transactor) SetTokenURI(opts *bind.TransactOpts, _tokenId *big.Int, _tokenURI string) (*types.Transaction, error) {
	return _ERC721.contract.Transact(opts, "setTokenURI", _tokenId, _tokenURI)
}

// SetTokenURI is a paid mutator transaction binding the contract method 0x162094c4.
//
// Solidity: function setTokenURI(uint256 _tokenId, string _tokenURI) returns()
func (_ERC721 *ERC721Session) SetTokenURI(_tokenId *big.Int, _tokenURI string) (*types.Transaction, error) {
	return _ERC721.Contract.SetTokenURI(&_ERC721.TransactOpts, _tokenId, _tokenURI)
}

// SetTokenURI is a paid mutator transaction binding the contract method 0x162094c4.
//
// Solidity: function setTokenURI(uint256 _tokenId, string _tokenURI) returns()
func (_ERC721 *ERC721TransactorSession) SetTokenURI(_tokenId *big.Int, _tokenURI string) (*types.Transaction, error) {
	return _ERC721.Contract.SetTokenURI(&_ERC721.TransactOpts, _tokenId, _tokenURI)
}
