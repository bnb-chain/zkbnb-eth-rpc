...
func (_ZkBNB *ZkBNBCaller) GetNftTokenURI(opts *bind.CallOpts, nftContentType uint8, nftContentHash [32]byte) (string, error) {
	var out []interface{}
	err := _ZkBNB.contract.Call(opts, &out, "getNftTokenURI", nftContentType, nftContentHash)
...
//
// Solidity: function getNftTokenURI(uint8 nftContentType, bytes32 nftContentHash) view returns(string tokenURI)
func (_ZkBNB *ZkBNBSession) GetNftTokenURI(nftContentType uint8, nftContentHash [32]byte) (string, error) {
	return _ZkBNB.Contract.GetNftTokenURI(&_ZkBNB.CallOpts, nftContentType, nftContentHash)
}

// GetNftTokenURI is a free data retrieval call binding the contract method 0xc55d3608.
//
// Solidity: function getNftTokenURI(uint8 nftContentType, bytes32 nftContentHash) view returns(string tokenURI)
func (_ZkBNB *ZkBNBCallerSession) GetNftTokenURI(nftContentType uint8, nftContentHash [32]byte) (string, error) {
	return _ZkBNB.Contract.GetNftTokenURI(&_ZkBNB.CallOpts, nftContentType, nftContentHash)
}
...
// PerformDesert is a paid mutator transaction binding the contract method 0xd7c3fb29.
//
// Solidity: function performDesert((uint16,uint32,uint64,bytes32,uint256,bytes32,bytes32) _storedBlockInfo, bytes _pubdata, uint256[] _proofs) returns()
func (_ZkBNB *ZkBNBTransactor) PerformDesert(opts *bind.TransactOpts, _storedBlockInfo StorageStoredBlockInfo, _pubdata []byte, _proofs []*big.Int) (*types.Transaction, error) {
	return _ZkBNB.contract.Transact(opts, "performDesert", _storedBlockInfo, _pubdata, _proofs)
}

// PerformDesert is a paid mutator transaction binding the contract method 0xd7c3fb29.
//
// Solidity: function performDesert((uint16,uint32,uint64,bytes32,uint256,bytes32,bytes32) _storedBlockInfo, bytes _pubdata, uint256[] _proofs) returns()
func (_ZkBNB *ZkBNBSession) PerformDesert(_storedBlockInfo StorageStoredBlockInfo, _pubdata []byte, _proofs []*big.Int) (*types.Transaction, error) {
	return _ZkBNB.Contract.PerformDesert(&_ZkBNB.TransactOpts, _storedBlockInfo, _pubdata, _proofs)
}

// PerformDesert is a paid mutator transaction binding the contract method 0xd7c3fb29.
//
// Solidity: function performDesert((uint16,uint32,uint64,bytes32,uint256,bytes32,bytes32) _storedBlockInfo, bytes _pubdata, uint256[] _proofs) returns()
func (_ZkBNB *ZkBNBTransactorSession) PerformDesert(_storedBlockInfo StorageStoredBlockInfo, _pubdata []byte, _proofs []*big.Int) (*types.Transaction, error) {
	return _ZkBNB.Contract.PerformDesert(&_ZkBNB.TransactOpts, _storedBlockInfo, _pubdata, _proofs)
}
