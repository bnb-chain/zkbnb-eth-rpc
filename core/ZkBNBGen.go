...
// PerformDesert is a paid mutator transaction binding the contract method 0x92e0d760.
//
// Solidity: function performDesert((uint16,uint32,uint64,bytes32,uint256,bytes32,bytes32) _storedBlockInfo, uint256 _nftRoot, (uint16,uint256,uint256) _assetExitData, (uint32,address,bytes32,bytes32,uint256,uint256) _accountExitData, uint256[16] _assetMerkleProof, uint256[32] _accountMerkleProof) returns()
