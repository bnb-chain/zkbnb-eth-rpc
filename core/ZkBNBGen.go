...
// PerformDesert is a paid mutator transaction binding the contract method 0x64b3d521.
//
// Solidity: function performDesert((uint32,uint32,uint256,uint256,uint256,uint256,uint256,uint256,uint256) _exitData, uint256[15] assetMerkleProof, uint256[31] accountMerkleProof, uint256[39] nftMerkleProof) returns()
...
// PerformDesertNft is a paid mutator transaction binding the contract method 0xfa34af9e.
//
// Solidity: function performDesertNft((uint64,uint256,uint256,uint256,uint256) _exitNftData, uint256 _accountRoot, uint256[39] _nftMerkleProof) returns()
func (_ZkBNB *ZkBNBTransactor) PerformDesertNft(opts *bind.TransactOpts, _exitNftData ExodusVerifierExitNftData, _accountRoot *big.Int, _nftMerkleProof [39]*big.Int) (*types.Transaction, error) {
	return _ZkBNB.contract.Transact(opts, "performDesertNft", _exitNftData, _accountRoot, _nftMerkleProof)
}

// PerformDesertNft is a paid mutator transaction binding the contract method 0xfa34af9e.
//
// Solidity: function performDesertNft((uint64,uint256,uint256,uint256,uint256) _exitNftData, uint256 _accountRoot, uint256[39] _nftMerkleProof) returns()
func (_ZkBNB *ZkBNBSession) PerformDesertNft(_exitNftData ExodusVerifierExitNftData, _accountRoot *big.Int, _nftMerkleProof [39]*big.Int) (*types.Transaction, error) {
	return _ZkBNB.Contract.PerformDesertNft(&_ZkBNB.TransactOpts, _exitNftData, _accountRoot, _nftMerkleProof)
}

// PerformDesertNft is a paid mutator transaction binding the contract method 0xfa34af9e.
//
// Solidity: function performDesertNft((uint64,uint256,uint256,uint256,uint256) _exitNftData, uint256 _accountRoot, uint256[39] _nftMerkleProof) returns()
func (_ZkBNB *ZkBNBTransactorSession) PerformDesertNft(_exitNftData ExodusVerifierExitNftData, _accountRoot *big.Int, _nftMerkleProof [39]*big.Int) (*types.Transaction, error) {
	return _ZkBNB.Contract.PerformDesertNft(&_ZkBNB.TransactOpts, _exitNftData, _accountRoot, _nftMerkleProof)
}
