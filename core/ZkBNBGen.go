...
// PerformDesert is a paid mutator transaction binding the contract method 0x561631d9.
//
// Solidity: function performDesert(uint256 _nftRoot, (uint32,uint32,uint256,uint256,bytes20,bytes32,bytes32,uint256,uint256) _exitData, uint256[16] _assetMerkleProof, uint256[32] _accountMerkleProof) returns()
func (_ZkBNB *ZkBNBTransactor) PerformDesert(opts *bind.TransactOpts, _nftRoot *big.Int, _exitData ExodusVerifierExitData, _assetMerkleProof [16]*big.Int, _accountMerkleProof [32]*big.Int) (*types.Transaction, error) {
...
//
// Solidity: function performDesert(uint256 _nftRoot, (uint32,uint32,uint256,uint256,bytes20,bytes32,bytes32,uint256,uint256) _exitData, uint256[16] _assetMerkleProof, uint256[32] _accountMerkleProof) returns()
func (_ZkBNB *ZkBNBSession) PerformDesert(_nftRoot *big.Int, _exitData ExodusVerifierExitData, _assetMerkleProof [16]*big.Int, _accountMerkleProof [32]*big.Int) (*types.Transaction, error) {
...
//
// Solidity: function performDesert(uint256 _nftRoot, (uint32,uint32,uint256,uint256,bytes20,bytes32,bytes32,uint256,uint256) _exitData, uint256[16] _assetMerkleProof, uint256[32] _accountMerkleProof) returns()
func (_ZkBNB *ZkBNBTransactorSession) PerformDesert(_nftRoot *big.Int, _exitData ExodusVerifierExitData, _assetMerkleProof [16]*big.Int, _accountMerkleProof [32]*big.Int) (*types.Transaction, error) {
	return _ZkBNB.Contract.PerformDesert(&_ZkBNB.TransactOpts, _nftRoot, _exitData, _assetMerkleProof, _accountMerkleProof)
}

// PerformDesertNft is a paid mutator transaction binding the contract method 0xff8e09ab.
//
// Solidity: function performDesertNft(uint256 _ownerAccountIndex, uint256 _accountRoot, (uint64,uint256,uint256,bytes32,uint8,uint256,uint256)[] _exitNfts, uint256[40][] _nftMerkleProofs) returns()
func (_ZkBNB *ZkBNBTransactor) PerformDesertNft(opts *bind.TransactOpts, _ownerAccountIndex *big.Int, _accountRoot *big.Int, _exitNfts []ExodusVerifierExitNftData, _nftMerkleProofs [][40]*big.Int) (*types.Transaction, error) {
...
//
// Solidity: function performDesertNft(uint256 _ownerAccountIndex, uint256 _accountRoot, (uint64,uint256,uint256,bytes32,uint8,uint256,uint256)[] _exitNfts, uint256[40][] _nftMerkleProofs) returns()
func (_ZkBNB *ZkBNBSession) PerformDesertNft(_ownerAccountIndex *big.Int, _accountRoot *big.Int, _exitNfts []ExodusVerifierExitNftData, _nftMerkleProofs [][40]*big.Int) (*types.Transaction, error) {
...
//
// Solidity: function performDesertNft(uint256 _ownerAccountIndex, uint256 _accountRoot, (uint64,uint256,uint256,bytes32,uint8,uint256,uint256)[] _exitNfts, uint256[40][] _nftMerkleProofs) returns()
func (_ZkBNB *ZkBNBTransactorSession) PerformDesertNft(_ownerAccountIndex *big.Int, _accountRoot *big.Int, _exitNfts []ExodusVerifierExitNftData, _nftMerkleProofs [][40]*big.Int) (*types.Transaction, error) {
	return _ZkBNB.Contract.PerformDesertNft(&_ZkBNB.TransactOpts, _ownerAccountIndex, _accountRoot, _exitNfts, _nftMerkleProofs)
}
