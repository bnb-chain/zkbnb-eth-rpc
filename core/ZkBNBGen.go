...
// PerformDesertNft is a paid mutator transaction binding the contract method 0x4337b4c3.
//
// Solidity: function performDesertNft((uint16,uint32,uint64,bytes32,uint256,bytes32,bytes32) _storedBlockInfo, uint256 _assetRoot, (uint32,address,bytes32,bytes32,uint256,uint256) _accountExitData, (uint40,uint256,uint256,uint256,uint256,bytes16,bytes16,uint8)[] _exitNfts, uint256[32] _accountMerkleProof, uint256[40][] _nftMerkleProofs) returns()
