...
// ExodusVerifierAccountExitData is an auto generated low-level Go binding around an user-defined struct.
...
// ExodusVerifierAssetExitData is an auto generated low-level Go binding around an user-defined struct.
...
// ExodusVerifierNftExitData is an auto generated low-level Go binding around an user-defined struct.
...
// PerformDesert is a paid mutator transaction binding the contract method 0x6ee78314.
//
// Solidity: function performDesert((uint16,uint32,uint64,bytes32,uint256,bytes32,bytes32) _storedBlockInfo, uint256 _nftRoot, (uint32,uint256,uint256) _assetExitData, (uint32,address,bytes32,bytes32,uint256,uint256) _accountExitData, uint256[16] _assetMerkleProof, uint256[32] _accountMerkleProof) returns()
func (_ZkBNB *ZkBNBTransactor) PerformDesert(opts *bind.TransactOpts, _storedBlockInfo StorageStoredBlockInfo, _nftRoot *big.Int, _assetExitData ExodusVerifierAssetExitData, _accountExitData ExodusVerifierAccountExitData, _assetMerkleProof [16]*big.Int, _accountMerkleProof [32]*big.Int) (*types.Transaction, error) {
...
//
// Solidity: function performDesert((uint16,uint32,uint64,bytes32,uint256,bytes32,bytes32) _storedBlockInfo, uint256 _nftRoot, (uint32,uint256,uint256) _assetExitData, (uint32,address,bytes32,bytes32,uint256,uint256) _accountExitData, uint256[16] _assetMerkleProof, uint256[32] _accountMerkleProof) returns()
func (_ZkBNB *ZkBNBSession) PerformDesert(_storedBlockInfo StorageStoredBlockInfo, _nftRoot *big.Int, _assetExitData ExodusVerifierAssetExitData, _accountExitData ExodusVerifierAccountExitData, _assetMerkleProof [16]*big.Int, _accountMerkleProof [32]*big.Int) (*types.Transaction, error) {
...
//
// Solidity: function performDesert((uint16,uint32,uint64,bytes32,uint256,bytes32,bytes32) _storedBlockInfo, uint256 _nftRoot, (uint32,uint256,uint256) _assetExitData, (uint32,address,bytes32,bytes32,uint256,uint256) _accountExitData, uint256[16] _assetMerkleProof, uint256[32] _accountMerkleProof) returns()
func (_ZkBNB *ZkBNBTransactorSession) PerformDesert(_storedBlockInfo StorageStoredBlockInfo, _nftRoot *big.Int, _assetExitData ExodusVerifierAssetExitData, _accountExitData ExodusVerifierAccountExitData, _assetMerkleProof [16]*big.Int, _accountMerkleProof [32]*big.Int) (*types.Transaction, error) {
	return _ZkBNB.Contract.PerformDesert(&_ZkBNB.TransactOpts, _storedBlockInfo, _nftRoot, _assetExitData, _accountExitData, _assetMerkleProof, _accountMerkleProof)
}

// PerformDesertNft is a paid mutator transaction binding the contract method 0x063c5e17.
//
// Solidity: function performDesertNft((uint16,uint32,uint64,bytes32,uint256,bytes32,bytes32) _storedBlockInfo, uint256 _assetRoot, (uint32,address,bytes32,bytes32,uint256,uint256) _accountExitData, (uint64,uint256,uint256,bytes32,uint8,uint256,uint256)[] _exitNfts, uint256[32] _accountMerkleProof, uint256[40][] _nftMerkleProofs) returns()
func (_ZkBNB *ZkBNBTransactor) PerformDesertNft(opts *bind.TransactOpts, _storedBlockInfo StorageStoredBlockInfo, _assetRoot *big.Int, _accountExitData ExodusVerifierAccountExitData, _exitNfts []ExodusVerifierNftExitData, _accountMerkleProof [32]*big.Int, _nftMerkleProofs [][40]*big.Int) (*types.Transaction, error) {
...
//
// Solidity: function performDesertNft((uint16,uint32,uint64,bytes32,uint256,bytes32,bytes32) _storedBlockInfo, uint256 _assetRoot, (uint32,address,bytes32,bytes32,uint256,uint256) _accountExitData, (uint64,uint256,uint256,bytes32,uint8,uint256,uint256)[] _exitNfts, uint256[32] _accountMerkleProof, uint256[40][] _nftMerkleProofs) returns()
func (_ZkBNB *ZkBNBSession) PerformDesertNft(_storedBlockInfo StorageStoredBlockInfo, _assetRoot *big.Int, _accountExitData ExodusVerifierAccountExitData, _exitNfts []ExodusVerifierNftExitData, _accountMerkleProof [32]*big.Int, _nftMerkleProofs [][40]*big.Int) (*types.Transaction, error) {
...
//
// Solidity: function performDesertNft((uint16,uint32,uint64,bytes32,uint256,bytes32,bytes32) _storedBlockInfo, uint256 _assetRoot, (uint32,address,bytes32,bytes32,uint256,uint256) _accountExitData, (uint64,uint256,uint256,bytes32,uint8,uint256,uint256)[] _exitNfts, uint256[32] _accountMerkleProof, uint256[40][] _nftMerkleProofs) returns()
func (_ZkBNB *ZkBNBTransactorSession) PerformDesertNft(_storedBlockInfo StorageStoredBlockInfo, _assetRoot *big.Int, _accountExitData ExodusVerifierAccountExitData, _exitNfts []ExodusVerifierNftExitData, _accountMerkleProof [32]*big.Int, _nftMerkleProofs [][40]*big.Int) (*types.Transaction, error) {
	return _ZkBNB.Contract.PerformDesertNft(&_ZkBNB.TransactOpts, _storedBlockInfo, _assetRoot, _accountExitData, _exitNfts, _accountMerkleProof, _nftMerkleProofs)
}
