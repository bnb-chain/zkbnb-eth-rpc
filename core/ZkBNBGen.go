...
// PerformDesert is a paid mutator transaction binding the contract method 0xb1601043.
//
// Solidity: function performDesert(bytes32 _nftRoot, (uint32,uint32,uint256,uint256,bytes32,bytes32,bytes32,uint256,uint256) _exitData, uint256[15] _assetMerkleProof, uint256[31] _accountMerkleProof) returns()
func (_ZkBNB *ZkBNBTransactor) PerformDesert(opts *bind.TransactOpts, _nftRoot [32]byte, _exitData ExodusVerifierExitData, _assetMerkleProof [15]*big.Int, _accountMerkleProof [31]*big.Int) (*types.Transaction, error) {
...
//
// Solidity: function performDesert(bytes32 _nftRoot, (uint32,uint32,uint256,uint256,bytes32,bytes32,bytes32,uint256,uint256) _exitData, uint256[15] _assetMerkleProof, uint256[31] _accountMerkleProof) returns()
func (_ZkBNB *ZkBNBSession) PerformDesert(_nftRoot [32]byte, _exitData ExodusVerifierExitData, _assetMerkleProof [15]*big.Int, _accountMerkleProof [31]*big.Int) (*types.Transaction, error) {
...
//
// Solidity: function performDesert(bytes32 _nftRoot, (uint32,uint32,uint256,uint256,bytes32,bytes32,bytes32,uint256,uint256) _exitData, uint256[15] _assetMerkleProof, uint256[31] _accountMerkleProof) returns()
func (_ZkBNB *ZkBNBTransactorSession) PerformDesert(_nftRoot [32]byte, _exitData ExodusVerifierExitData, _assetMerkleProof [15]*big.Int, _accountMerkleProof [31]*big.Int) (*types.Transaction, error) {
	return _ZkBNB.Contract.PerformDesert(&_ZkBNB.TransactOpts, _nftRoot, _exitData, _assetMerkleProof, _accountMerkleProof)
}

// PerformDesertNft is a paid mutator transaction binding the contract method 0xdd922388.
//
// Solidity: function performDesertNft(uint256 _ownerAccountIndex, bytes32 _accountRoot, (uint64,uint256,bytes32,uint256,uint256)[] _exitNfts, uint256[39][] _nftMerkleProofs) returns()
func (_ZkBNB *ZkBNBTransactor) PerformDesertNft(opts *bind.TransactOpts, _ownerAccountIndex *big.Int, _accountRoot [32]byte, _exitNfts []ExodusVerifierExitNftData, _nftMerkleProofs [][39]*big.Int) (*types.Transaction, error) {
...
//
// Solidity: function performDesertNft(uint256 _ownerAccountIndex, bytes32 _accountRoot, (uint64,uint256,bytes32,uint256,uint256)[] _exitNfts, uint256[39][] _nftMerkleProofs) returns()
func (_ZkBNB *ZkBNBSession) PerformDesertNft(_ownerAccountIndex *big.Int, _accountRoot [32]byte, _exitNfts []ExodusVerifierExitNftData, _nftMerkleProofs [][39]*big.Int) (*types.Transaction, error) {
...
//
// Solidity: function performDesertNft(uint256 _ownerAccountIndex, bytes32 _accountRoot, (uint64,uint256,bytes32,uint256,uint256)[] _exitNfts, uint256[39][] _nftMerkleProofs) returns()
func (_ZkBNB *ZkBNBTransactorSession) PerformDesertNft(_ownerAccountIndex *big.Int, _accountRoot [32]byte, _exitNfts []ExodusVerifierExitNftData, _nftMerkleProofs [][39]*big.Int) (*types.Transaction, error) {
	return _ZkBNB.Contract.PerformDesertNft(&_ZkBNB.TransactOpts, _ownerAccountIndex, _accountRoot, _exitNfts, _nftMerkleProofs)
}
