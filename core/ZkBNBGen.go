...
// PerformDesert is a paid mutator transaction binding the contract method 0x39c04c7e.
//
// Solidity: function performDesert(uint256 _nftRoot, (uint32,uint32,uint256,uint256,bytes32,bytes32,bytes32,uint256,uint256) _exitData, uint256[16] _assetMerkleProof, uint256[32] _accountMerkleProof) returns()
...
// PerformDesertNft is a paid mutator transaction binding the contract method 0x67344745.
//
// Solidity: function performDesertNft(uint256 _ownerAccountIndex, uint256 _accountRoot, (uint64,uint256,bytes32,uint256,uint256)[] _exitNfts, uint256[40][] _nftMerkleProofs) returns()
